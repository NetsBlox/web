...
export default () => (
  <Page>
    <h1><Bird className="h-12 w-12 mr-3 inline-block"/>Wildlife Conservation</h1>
    ...
    <ul>
      <li><Presentation className="h-6 w-6 mr-3 inline-block"/><a href="https://docs.google.com/presentation/d/16jVldPfZpInwWujLVMXu-xmSnAb3sDPTJi9V2TnjJf0/edit?usp=sharing">Combined slides</a> for all four days of instruction</li>
    </ul>
    ...
    <Card>
      <h2><Camera className="h-6 w-6 mr-3 inline-block"/>Wildcam Camera Plotter</h2>
      ...
      <a href="https://editor.netsblox.org/?action=present&Username=devinjean&ProjectName=wildcam-plotter-simple&editMode&noRun"><button><BookOpenCheck className="h-6 w-6 mr-3 inline-block"/>Completed Project</button></a>
    </Card>

    <Card>
      <h2><Map className="h-6 w-6 mr-3 inline-block"/>Movebank Animal Tracker</h2>
      ...
      <a href="https://editor.netsblox.org/?action=present&Username=devinjean&ProjectName=movebank-plotter-simple&editMode&noRun"><button><BookOpenCheck className="h-6 w-6 mr-3 inline-block"/>Completed Project</button></a>
    </Card>

    <Card>
      <h2><Trees className="h-6 w-6 mr-3 inline-block"/>Tree of Life</h2>
      ...
      <a href="https://editor.netsblox.org/?action=present&Username=devinjean&ProjectName=tree-of-life-simplest-starter&editMode&noRun"><button><BookOpen className="h-6 w-6 mr-3 inline-block"/>Starter Project</button></a>
      <a href="https://editor.netsblox.org/?action=present&Username=devinjean&ProjectName=tree-of-life-simplest&editMode&noRun"><button><BookOpenCheck className="h-6 w-6 mr-3 inline-block"/>Completed Project</button></a>
    </Card>

    <Card>
      <h2><Gamepad2 className="h-6 w-6 mr-3 inline-block"/>Species Guessing Game</h2>
      ...
      <a href="https://editor.netsblox.org/?action=present&Username=devinjean&ProjectName=wildcam-guess-game&editMode&noRun"><button><BookOpenCheck className="h-6 w-6 mr-3 inline-block"/>Completed Project</button></a>
    </Card>
  </Page>
);
