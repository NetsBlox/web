...
export default () => (
  <Page>
    ...
    <Card>
      ...
      <p>The RoboScape Online simulator loads specially-designed "scenario" files that specify details of the virtual environment, the available robots, the task to complete, and so on. These scenario files are simply NetsBlox projects, which students can create, customize, and share.</p>
    </Card>

    <Card>
      <h3><PocketKnife/>Advanced Sensing Features</h3>
      <p>Due to its simulated nature, RoboScape Online is able to simulate advanced types of sensors that would be impractically expensive in real-world classroom robotics projects. For instance, some scenarios equip robots with GPS or LIDAR sensors for advanced autonomous driving tasks.</p>
    </Card>

    <Card>
      <h3><Users/>Collaboration</h3>
      <p>RoboScape Online environments can be shared, allowing students to join the same robotics simulation and remotely manipulate the same robots. This allows students to collaborate on robotics problems even in online classroom scenarios where students cannot meet in-person.</p>
    </Card>

    <Card>
      <h3><PackageOpen/>Free and Open-Source</h3>
      <p>Simulated robots are completely free, allowing RoboScape to be used in any classroom or even at home.</p>
    </Card>
