...
export default () => (
  <Page>
    ...
    <Card>
      ...
      <p>PyBlox is a complete Python equivalent for NetsBlox. This includes access to features such as sprites, turtle graphics, pen drawings, concurrently (simultaneously) executing scripts, key events, and more. Importantly, this also includes all of the advanced networking features of NetsBlox, allowing students to still make use of NetsBlox RPCs and internet-based message passing even in the Python world.</p>
    </Card>

    <Card>
      <h3><Code/>Develop Real Python Programming Skills</h3>
      <p>PyBlox is a native tool, meaning it must be installed on your computer rather than running in the browser like NetsBlox. The reason for this is that PyBlox gives users the full, unlimited power of Python, rather than only a small subset that can run in isolation in a web browser. Because of this, any Python knowledge learned through PyBlox is directly applicable to real-world Python programming.</p>
    </Card>

    <Card>
      <h3><PackageOpen/>Free and Open-Source</h3>
      <p>Just like NetsBlox, PyBlox is a free and open-source tool. This means that there will never be any financial cost to using PyBlox either at home or in the classroom.</p>
