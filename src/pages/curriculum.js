  ...
  <Page>
    ...
    <Grid cols={3}>
      <div className={entryClasses}>
        ...
        <a href="roccem"><button>View Curriculum</button></a>
      </div>
      ...
      <div className={entryClasses}>
        ...
        <a href="cybersecurity"><button>View Curriculum</button></a>
      </div>
      ...
      <div className={entryClasses}>
        ...
        <a href="https://csfrontiers.org/curriculum.html"><button>View Curriculum</button></a>
      </div>
      ...
      <div className={entryClasses}>
        ...
        <a href="wildlife"><button>View Curriculum</button></a>
      </div>
      ...
      <div className={entryClasses}>
        ...
        <a href="aicamp"><button>View Curriculum</button></a>
      </div>
    </Grid>
  </Page>
);
