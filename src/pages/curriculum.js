...
export default () => (
  <Page>
    ...
    <Grid cols={3}>
      <div><h1><Users/></h1><p className="text-center">For various educational levels and skillsets</p></div>
      <div><h1><BookOpen/></h1><p className="text-center">Curated tutorials, projects, and lesson ideas</p></div>
      <div><h1><Lightbulb/></h1><p className="text-center">Engaging and interactive education experiences</p></div>
    </Grid>
    ...
    <Grid cols={3}>
      ...
      <div className={entryClasses}>
        <h2><Rocket/>Robotics and Cybersecurity</h2>
      ...
      <div className={entryClasses}>
        <h2><Bird/>Wildlife Conservation</h2>
